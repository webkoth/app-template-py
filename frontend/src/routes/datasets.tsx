  ...
  return (
    <PageMain>
      ...
      <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
        {/* Числа предела здесь нет намеренно. Он задаётся настройкой
            UPLOAD_MAX_BYTES, а на контуре его вдобавок режет
            client_max_body_size в nginx — и эти два предела не обязаны
            совпадать. Вписанное сюда «32 МиБ» врало на контуре, где vhost
            пропускает мегабайт: человек читал обещание и получал отказ.
            Предел называет тот, кто отказывает, и называет настоящий. */}
        CSV или XLSX. Файл разбирается в фоне: строки и сводка появляются не
        сразу, а ход работы виден на экране «Задачи». По разобранной таблице
        можно обучить модель и сделать предсказание.
      </p>
